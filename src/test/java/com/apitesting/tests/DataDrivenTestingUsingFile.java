...
public class DataDrivenTestingUsingFile extends BaseTest{
	...
	public void DataDrivenTestingUsingJson(LinkedHashMap<String,String> testData) throws JsonProcessingException {
		{
			...
			Booking booking = 
					new Booking(testData.get("firstname"), testData.get("lastname"), "breakfast", 1000, true, bookingDates);
	...
	public Object[] getTestDataJson()
	{
		...
		try {
			String jsonTestData=
					FileUtils.readFileToString(new File(FileNameConstants.JSON_TEST_DATA),"UTF-8");
